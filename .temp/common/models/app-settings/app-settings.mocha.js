...
const app_settings_mock_1 = require('./app-settings.mock');
describe('AppSettings', () => {
    ...
    describe("errors", () => {
        it("errors if there is no matching cluster", () => {
            ...
            js.clusters = [];
            chai_1.expect(() => app_settings_1.AppSettings.fromJS(js, context)).to.throw("Can not find cluster 'druid' for data cube 'wiki'");
        });
    });
    ...
    describe("general", () => {
        ...
        it("converts to client settings", () => {
            const settings = app_settings_mock_1.AppSettingsMock.wikiOnlyWithExecutor();
