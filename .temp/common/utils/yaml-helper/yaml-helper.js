...
function clusterToYAML(cluster, withComments) {
    ...
    yamlPropAdder(lines, withComments, {
        ...
        defaultValue: index_1.Cluster.DEFAULT_TIMEOUT
    });
    yamlPropAdder(lines, withComments, {
        object: cluster,
        ...
        defaultValue: index_1.Cluster.DEFAULT_SOURCE_LIST_SCAN
    });
    yamlPropAdder(lines, withComments, {
        object: cluster,
    ...
    yamlPropAdder(lines, withComments, {
        ...
        defaultValue: index_1.Cluster.DEFAULT_SOURCE_LIST_REFRESH_INTERVAL
    });
    yamlPropAdder(lines, withComments, {
        object: cluster,
    ...
    yamlPropAdder(lines, withComments, {
        ...
        defaultValue: index_1.Cluster.DEFAULT_SOURCE_REINTROSPECT_INTERVAL
    });
    if (withComments) {
    ...
    switch (cluster.type) {
        case 'druid':
            yamlPropAdder(lines, withComments, {
                ...
                defaultValue: index_1.Cluster.DEFAULT_INTROSPECTION_STRATEGY
            });
            yamlPropAdder(lines, withComments, {
                object: cluster,
...
function dataCubeToYAML(dataCube, withComments) {
    ...
    yamlPropAdder(lines, withComments, {
        ...
        defaultValue: index_1.DataCube.DEFAULT_DEFAULT_TIMEZONE
    });
    yamlPropAdder(lines, withComments, {
        object: dataCube,
        propName: 'defaultDuration',
        comment: 'The default duration for the time filter',
        defaultValue: index_1.DataCube.DEFAULT_DEFAULT_DURATION
    });
    yamlPropAdder(lines, withComments, {
        object: dataCube,
